    ...
    <div className="min-h-screen bg-gradient-to-br from-violet-100 via-purple-50 to-fuchsia-100 flex items-center justify-center p-4">
      ...
      <Card className="relative z-10 w-full max-w-md bg-white/80 border-purple-100 backdrop-blur-xl shadow-2xl shadow-purple-200/50">
        <CardHeader className="text-center pb-2">
          ...
          <CardTitle className="text-2xl font-bold text-gray-800">Willkommen zurück</CardTitle>
            ...
            <div className="space-y-3 text-sm">
              <div>
                ...
                <div className="mt-1 space-y-1">
                  <code className="text-purple-700 bg-white px-2 py-0.5 rounded text-xs border border-purple-100 block">ceo@timetracker.local / admin123</code>
                  <code className="text-purple-700 bg-white px-2 py-0.5 rounded text-xs border border-purple-100 block">hr@timetracker.local / admin123</code>
                </div>
              </div>
              <div>
                <span className="font-medium text-purple-700 text-xs">Entwicklung</span>
                <div className="mt-1 space-y-1">
                  <code className="text-purple-700 bg-white px-2 py-0.5 rounded text-xs border border-purple-100 block">lead.dev@timetracker.local / user123</code>
                  <code className="text-purple-700 bg-white px-2 py-0.5 rounded text-xs border border-purple-100 block">anna.dev@timetracker.local / user123</code>
                  <code className="text-purple-700 bg-white px-2 py-0.5 rounded text-xs border border-purple-100 block">ben.dev@timetracker.local / user123</code>
                  <code className="text-purple-700 bg-white px-2 py-0.5 rounded text-xs border border-purple-100 block">cora.dev@timetracker.local / user123</code>
                </div>
              </div>
              <div>
                <span className="font-medium text-purple-700 text-xs">Vertrieb</span>
                <div className="mt-1 space-y-1">
                  <code className="text-purple-700 bg-white px-2 py-0.5 rounded text-xs border border-purple-100 block">lead.sales@timetracker.local / user123</code>
                  <code className="text-purple-700 bg-white px-2 py-0.5 rounded text-xs border border-purple-100 block">david.sales@timetracker.local / user123</code>
                  <code className="text-purple-700 bg-white px-2 py-0.5 rounded text-xs border border-purple-100 block">eva.sales@timetracker.local / user123</code>
                  <code className="text-purple-700 bg-white px-2 py-0.5 rounded text-xs border border-purple-100 block">finn.sales@timetracker.local / user123</code>
                </div>
              </div>
            </div>
          </div>
  ...
  return (
    <Suspense fallback={
      <div className="min-h-screen bg-gradient-to-br from-violet-100 via-purple-50 to-fuchsia-100 flex items-center justify-center">
        <div className="animate-pulse text-purple-600">Laden...</div>
      </div>
    }>
      <LoginForm />
    </Suspense>
